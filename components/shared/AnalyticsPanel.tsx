          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2.5">
              ...
              <motion.div variants={cardVariants} className="bg-surface-2 border border-[rgba(255,255,255,0.03)] rounded-xl p-3.5 flex flex-col gap-1">
                <div className="flex items-center gap-1.5 text-text-tertiary">
                  ...
                  <span className="text-[9px] uppercase tracking-wider font-semibold">Exec Time</span>
                </div>
              ...
              <motion.div variants={cardVariants} className="bg-surface-2 border border-[rgba(255,255,255,0.03)] rounded-xl p-3.5 flex flex-col gap-1">
                <div className="flex items-center gap-1.5 text-text-tertiary">
                  ...
                  <span className="text-[9px] uppercase tracking-wider font-semibold">Path Cost</span>
                </div>
              ...
              <motion.div variants={cardVariants} className="bg-surface-2 border border-[rgba(255,255,255,0.03)] rounded-xl p-3.5 flex flex-col gap-1">
                <div className="flex items-center gap-1.5 text-text-tertiary">
                  ...
                  <span className="text-[9px] uppercase tracking-wider font-semibold">Expanded</span>
                </div>
                <div className="flex items-baseline">
              ...
              <motion.div variants={cardVariants} className="bg-surface-2 border border-[rgba(255,255,255,0.03)] rounded-xl p-3.5 flex flex-col gap-1">
                <div className="flex items-center gap-1.5 text-text-tertiary">
                  ...
                  <span className="text-[9px] uppercase tracking-wider font-semibold">Peak Front</span>
                </div>
                <div className="flex items-baseline">
            ...
            <div className="flex flex-col gap-2.5 bg-surface-2 border border-[rgba(255,255,255,0.03)] rounded-xl p-4 mt-1">
              <div className="flex justify-between items-center text-xs">
                <span className="text-text-tertiary">Branching Factor</span>
                <span className="font-mono text-white">{metrics.branchingFactor.toFixed(2)}</span>
              </div>
              <div className="w-full h-px bg-[rgba(255,255,255,0.05)]" />
              <div className="flex justify-between items-center text-xs">
                <span className="text-text-tertiary">Total Operations</span>
                <span className="font-mono text-white">{metrics.totalOps.toLocaleString()}</span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2.5 bg-surface-2 border border-[rgba(255,255,255,0.03)] rounded-xl p-4">
              ...
              <div className="flex justify-between items-center text-xs">
                <span className="text-text-tertiary">Time Complexity</span>
                <span className="font-mono text-accent-blue font-semibold">{metrics.timeComplexity}</span>
              </div>
              <div className="w-full h-px bg-[rgba(255,255,255,0.05)]" />
              <div className="flex justify-between items-center text-xs">
                <span className="text-text-tertiary">Space Complexity</span>
                <span className="font-mono text-accent-amber font-semibold">{metrics.spaceComplexity}</span>
              </div>
            </div>
          </motion.div>
        )}
