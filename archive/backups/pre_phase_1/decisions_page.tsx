...
import { checkWinner, getAvailableMoves } from '@/lib/algorithms/minimax'
...
export default function DecisionsPage() {
  ...
  const localMinimaxFallback = useCallback((b: Cell[], useAlphaBeta: boolean): MinimaxResult => {
    ...
    const { runMinimax, runAlphaBeta } = require('@/lib/algorithms/minimax')
    return useAlphaBeta ? runAlphaBeta(b) : runMinimax(b)
  }, [])
